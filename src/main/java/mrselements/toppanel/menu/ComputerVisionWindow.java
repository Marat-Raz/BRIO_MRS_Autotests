...
public class ComputerVisionWindow {
  ...
  public void selectCameraPresetDefaultPreset() {
    methodsForElements.clickingOnListAndSelectListItem(CAMERA_PRESET,
        CAMERA_PRESET_POPUP_DEFAULT_PRESET);
  }
  ...
  public void selectCameraPresetHighResHighAccuracyPreset() {
    methodsForElements.clickingOnListAndSelectListItem(CAMERA_PRESET,
        CAMERA_PRESET_POPUP_HIGH_RES_HIGH_ACCURACY_PRESET);
  }
  ...
  public void selectCameraPresetHighResHighDensityPreset() {
    methodsForElements.clickingOnListAndSelectListItem(CAMERA_PRESET,
        CAMERA_PRESET_POPUP_HIGH_RES_HIGH_DENSITY_PRESET);
  }
