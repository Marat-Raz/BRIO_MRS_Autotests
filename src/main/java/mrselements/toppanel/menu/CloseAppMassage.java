...
public class CloseAppMassage {
  ...
  public static final By YES_BUTTON_CLOSE_APPLICATION = By.xpath(
      "//Button[.//TextBlock[@Text='Да']]");
  public static final By NO_BUTTON_CLOSE_APPLICATION = By.xpath(
      "//Button[.//TextBlock[@Text='Нет']]");
  ...
  public static void waitOpenCloseAppMassage() {
    (new WebDriverWait(driver, Duration.ofSeconds(3)))
        .until(
            ExpectedConditions.visibilityOfElementLocated(NOTIFICATION_DIALOG_CLOSE_APPLICATION));
  }
