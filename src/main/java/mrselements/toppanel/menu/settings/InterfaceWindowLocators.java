...
public class InterfaceWindowLocators {
  ...
  public static final By INTERFACE_X_BUTTON =
      By.xpath(
          "//Button[.//TextBlock[@Text='Интерфейс' or @Text='Interface']]/following-sibling::*");
  ...
  public static final By VISIBILITY_RANGE_OF_OBJECTS_SLIDER =
      By.xpath(
          "//TextBlock[@Text='Дальность видимости объектов']/parent::*/parent::*/child::Slider");
  ...
  public static final By RENDERING_LEVEL_OF_DETAIL_SLIDER =
      By.xpath(
          "//TextBlock[@Text='Уровень детализации отрисовки']/parent::*/parent::*/child::Slider");
  ...
  public static final By FAR_CLIPPING_PLANE_SLIDER =
      By.xpath(
          "//TextBlock[@Text='Дальняя отсекающая плоскость']/parent::*/parent::*/child::Slider");
  public static final By DISPLAY_TASK_OUT_OF_SIGHT_TOGGLE_BUTTON =
      By.xpath(
          "//TextBlock[@Text='Отображать метки задач, находящихся вне поля зрения']/following-sibling::*");
  public static final By MAXIMUM_RENDERING_DISTANCE_LABELS_OUTPUT =
      By.xpath(
          "//TextBlock[@Text='Максимальная дальность отрисовки меток задач']/following-sibling::*");
  public static final By MAXIMUM_RENDERING_DISTANCE_LABELS_SLIDER =
      By.xpath(
          "//TextBlock[@Text='Максимальная дальность отрисовки меток задач']/parent::*/parent::*/child::Slider");
  ...
  public static final By SCROLL_BAR_INCREASE_BUTTON = By.xpath(
      "//SettingsView/Border/ContentPresenter/" +
