...
public class DeveloperModeLocators {
  ...
  public static final By DEVELOPER_MODE_WINDOW = By.xpath(
      "//Button[.//TextBlock[@Text='Разработка']]/parent::*");
  ...
  public static final By SHOW_DEPTH_MAP_INSTEAD_OF_CAMERA_IMAGE_TOGGLE_BUTTON =
      By.xpath(
          "//TextBlock[@Text='Показывать карту глубины вместо изображения с камеры']/following-sibling::*");
  ...
  public static final By VIRTUAL_KEYBOARD_TYPE_TOGGLE_BUTTON =
      By.xpath(
          "//TextBlock[@Text='Тип виртуальной клавиатуры']/parent::*/descendant::ToggleButton");
  ...
  public static final By VOICE_INPUT_DEVICE_TOGGLE_BUTTON =
      By.xpath(
          "//TextBlock[@Text='Устройство голосового ввода']/parent::*/descendant::ToggleButton");
  ...
  public static final By MOVE_THE_MODEL_S_CAMERA_BEHIND_REAL_CAMERA_TOGGLE_BUTTON =
      By.xpath(
          "//TextBlock[@Text='Перемещать камеру модели за реальной камерой']/following-sibling::*");
  ...
  public static final By DISTANCE_TO_COINCIDENT_FEATURES_SLIDER =
      By.xpath(
          "//TextBlock[@Text='Расстояние до совпадения объектов']/parent::*/parent::*/child::Slider");
  ...
  public static final By TRANSPARENCY_OF_AN_INTERSECTION_OBJECT_SLIDER =
      By.xpath(
          "//TextBlock[@Text='Прозрачность объекта пересечения']/parent::*/parent::*/child::Slider");
