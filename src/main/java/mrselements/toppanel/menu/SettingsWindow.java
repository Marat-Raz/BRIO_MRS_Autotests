...
public class SettingsWindow {
  ...
  public static final By SETTINGS_GO_BACK = By.xpath(
      "//Button[.//TextBlock[@Text='Настройки' or @Text='Settings']]");
  public static final By SETTINGS_X_BUTTON = By.xpath(
      "//Button[.//TextBlock[@Text='Настройки' or @Text='Settings']]/following-sibling::*");
  public static final By INTERFACE_BUTTON = By.xpath(
      "//Button[.//TextBlock[@Text='Интерфейс' or @Text='Interface']]");
  public static final By CV_SETTINGS_BUTTON = By.xpath(
      "//Button[.//TextBlock[@Text='Настройки CV']]");
  public static final By ABOUT_BUTTON = By.xpath("//Button[.//TextBlock[@Text='Об устройстве']]");
  public static final By DEVELOPMENT_BUTTON = By.xpath(
      "//Button[.//TextBlock[@Text='Разработка']]");
