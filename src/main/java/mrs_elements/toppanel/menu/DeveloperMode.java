...
import static mrs_elements.toppanel.menu.DeveloperModeLocators.CAMERA_ANIMATION_SPEED_OUTPUT;
import static mrs_elements.toppanel.menu.DeveloperModeLocators.CAMERA_ANIMATION_SPEED_SLIDER;
import static mrs_elements.toppanel.menu.DeveloperModeLocators.COLLECT_BUTTON;
import static mrs_elements.toppanel.menu.DeveloperModeLocators.COMPUTER_VISION_BUTTON;
import static mrs_elements.toppanel.menu.DeveloperModeLocators.DATASET_BTN;
...
import static mrs_elements.toppanel.menu.DeveloperModeLocators.DEVELOPER_MODE_X_BUTTON;
import static mrs_elements.toppanel.menu.DeveloperModeLocators.DISTANCE_TO_COINCIDENT_FEATURES_OUTPUT;
import static mrs_elements.toppanel.menu.DeveloperModeLocators.DISTANCE_TO_COINCIDENT_FEATURES_SLIDER;
import static mrs_elements.toppanel.menu.DeveloperModeLocators.INTERSECTION_LINE_SIZE_OUTPUT;
import static mrs_elements.toppanel.menu.DeveloperModeLocators.INTERSECTION_LINE_SIZE_SLIDER;
import static mrs_elements.toppanel.menu.DeveloperModeLocators.MINIMAP_MODE_POPUP_MAP_ROTATION;
import static mrs_elements.toppanel.menu.DeveloperModeLocators.MINIMAP_MODE_POPUP_ROTATE_MARKER;
import static mrs_elements.toppanel.menu.DeveloperModeLocators.MINIMAP_MODE_TOGGLE_BUTTON;
import static mrs_elements.toppanel.menu.DeveloperModeLocators.MOVE_THE_MODEL_S_CAMERA_BEHIND_REAL_CAMERA_TOGGLE_BUTTON;
import static mrs_elements.toppanel.menu.DeveloperModeLocators.REPEAT_BUTTON_BY_SCROLL_BAR;
import static mrs_elements.toppanel.menu.DeveloperModeLocators.SELECT_COINCIDENT_FEATURES_TOGGLE_BUTTON;
import static mrs_elements.toppanel.menu.DeveloperModeLocators.SHOW_DEPTH_MAP_INSTEAD_OF_CAMERA_IMAGE_TOGGLE_BUTTON;
import static mrs_elements.toppanel.menu.DeveloperModeLocators.SHOW_STATISTICS_TOGGLE_BUTTON;
import static mrs_elements.toppanel.menu.DeveloperModeLocators.STATISTICS_WINDOW;
import static mrs_elements.toppanel.menu.DeveloperModeLocators.TRANSPARENCY_OF_AN_INTERSECTION_OBJECT_OUTPUT;
import static mrs_elements.toppanel.menu.DeveloperModeLocators.TRANSPARENCY_OF_AN_INTERSECTION_OBJECT_SLIDER;
import static mrs_elements.toppanel.menu.DeveloperModeLocators.VERTICAL_SYNC_TOGGLE_BUTTON;
import static mrs_elements.toppanel.menu.DeveloperModeLocators.VIRTUAL_KEYBOARD_TYPE_POPUP_BUILT_INTO_MRS;
import static mrs_elements.toppanel.menu.DeveloperModeLocators.VIRTUAL_KEYBOARD_TYPE_POPUP_NO_VIRTUAL_KEYBOARD;
import static mrs_elements.toppanel.menu.DeveloperModeLocators.VIRTUAL_KEYBOARD_TYPE_POPUP_SYSTEM_WINDOWS;
import static mrs_elements.toppanel.menu.DeveloperModeLocators.VIRTUAL_KEYBOARD_TYPE_TOGGLE_BUTTON;
import static mrs_elements.toppanel.menu.DeveloperModeLocators.VOICE_INPUT_DEVICE_POPUP;
import static mrs_elements.toppanel.menu.DeveloperModeLocators.VOICE_INPUT_DEVICE_TOGGLE_BUTTON;
...
public class DeveloperMode {
  ...
  public void selectMinimapModeMapRotation() {
    methodsForElements.clickingOnListAndSelectListItem(MINIMAP_MODE_TOGGLE_BUTTON,
        MINIMAP_MODE_POPUP_MAP_ROTATION);
  }

  @Step("Выбор элемента «Вращение маркера» выпадающего списка «Режим миникарты»")
  public void selectMinimapModeRotateMarker() {
    methodsForElements.clickingOnListAndSelectListItem(MINIMAP_MODE_TOGGLE_BUTTON,
        MINIMAP_MODE_POPUP_ROTATE_MARKER);
  }

  @Step("Считываем установленное значение для «Тип виртуальной клавиатуры»")
  public String virtualKeyboardTypeIs() {
    String virtualKeyboardTypeIs = driver.findElement(VIRTUAL_KEYBOARD_TYPE_TOGGLE_BUTTON)
        .getText();
  ...
  public void selectVirtualKeyboardTypeBuiltIntoMrs() {
    methodsForElements.clickingOnListAndSelectListItem(VIRTUAL_KEYBOARD_TYPE_TOGGLE_BUTTON,
        VIRTUAL_KEYBOARD_TYPE_POPUP_BUILT_INTO_MRS);
  }
  ...
  public void selectVirtualKeyboardTypeSystemWindows() {
    methodsForElements.clickingOnListAndSelectListItem(VIRTUAL_KEYBOARD_TYPE_TOGGLE_BUTTON,
        VIRTUAL_KEYBOARD_TYPE_POPUP_SYSTEM_WINDOWS);
  }
  ...
  public void selectVirtualKeyboardTypeNoVirtualKeyboard() {
    methodsForElements.clickingOnListAndSelectListItem(VIRTUAL_KEYBOARD_TYPE_TOGGLE_BUTTON,
        VIRTUAL_KEYBOARD_TYPE_POPUP_NO_VIRTUAL_KEYBOARD);
  }
  ...
  public boolean theModelSCameraBehindRealCameraToggleButtonIsEnabled() {
    return methodsForElements.switchEnabled(
        MOVE_THE_MODEL_S_CAMERA_BEHIND_REAL_CAMERA_TOGGLE_BUTTON);
  }
  ...
  public boolean sliderDistanceToCoincidentFeaturesIsAppear() {
    String attr = driver.findElement(DISTANCE_TO_COINCIDENT_FEATURES_SLIDER)
    ...
    if (f.isDirectory()) {
      ...
      for (File listFile : listFiles) {
        if (listFile.lastModified() > timeAgo) {
          System.out.println(
              "Найден файл созданный в течении " + minutesBack + " минут: " + listFile);
          files.add(listFile);
          listFile.delete();
