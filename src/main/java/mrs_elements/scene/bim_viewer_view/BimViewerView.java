...
public class BimViewerView {
    ...
    public static final By TOGGLE_MARKERS_PANEL_COMMAND_VIEW = By.className("ToggleMarkersPanelCommandView");
    public static final By LOAD_IFC_COMMAND_VIEW = By.className("LoadIfcCommandView");
    public static final By OPEN_MAPPING_PANEL_COMMAND_VIEW = By.className("OpenMappingPanelCommandView");
    public static final By OPEN_TOOLS_PANEL_COMMAND_VIEW = By.className("OpenToolsPanelCommandView");
    public static final By OBJECTIVES_PANEL_COMMAND_VIEW = By.className("ToggleObjectivesPanelCommandView");
    public static final By BCF_PANEL_COMMAND_VIEW = By.className("ToggleBCFPanelCommandView");
    public static final By SWITCH_MINIMAP_AND_CUBE_VIEW_BTN = By.xpath("//SwitchMinimapAndCubeView//Button");
    public static final By OPEN_MRS_CAMERA_BUTTON_VIEW = By.xpath("//OpenMrsCameraButtonView//Button");
